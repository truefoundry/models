...
|----------|--------|-------------|
| OpenRouter | 995 | Unified API for open source models |
| Microsoft Foundry | 482 | OpenAI and Foundry catalog models on Microsoft Foundry |
| Google Vertex AI | 438 | Gemini, PaLM on GCP |
| Together AI | 388 | Open source model hosting |
| DeepInfra | 273 | Open source model hosting |
| Azure OpenAI | 252 | OpenAI models on Azure |
| AWS Bedrock | 244 | Claude, Llama, Titan, Mistral on AWS |
| Azure AI Foundry | 239 | Azure AI models |
| OpenAI | 163 | GPT-4, GPT-4o, GPT-5, o1, o3, DALL-E, Whisper, TTS |
| Deepgram | 144 | Speech-to-text and text-to-speech models |
| Mistral AI | 107 | Mistral, Mixtral, Codestral |
| xAI | 93 | Grok models |
| Google Gemini | 89 | Gemini Pro, Ultra, Flash |
| Databricks | 68 | Databricks-hosted models |
| Aws Bedrock Mantle | 59 |  |
| Cohere | 40 | Command, Embed models |
| SambaNova | 31 | Enterprise AI models |
| Anthropic | 29 | Claude 3, Claude 3.5, Claude 4 |
