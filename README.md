...
|----------|--------|-------------|
| OpenRouter | 777 | Unified API for open source models |
| Google Vertex AI | 405 | Gemini, PaLM on GCP |
| Together AI | 347 | Open source model hosting |
| AWS Bedrock | 211 | Claude, Llama, Titan, Mistral on AWS |
| DeepInfra | 207 | Open source model hosting |
...
| Mistral AI | 90 | Mistral, Mixtral, Codestral |
| xAI | 86 | Grok models |
