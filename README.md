...
|----------|--------|-------------|
| OpenRouter | 942 | Unified API for open source models |
| Google Vertex AI | 436 | Gemini, PaLM on GCP |
| Microsoft Foundry | 428 | OpenAI and Foundry catalog models on Microsoft Foundry |
| Together AI | 384 | Open source model hosting |
| DeepInfra | 262 | Open source model hosting |
| Azure OpenAI | 240 | OpenAI models on Azure |
| AWS Bedrock | 233 | Claude, Llama, Titan, Mistral on AWS |
| Azure AI Foundry | 221 | Azure AI models |
| OpenAI | 160 | GPT-4, GPT-4o, GPT-5, o1, o3, DALL-E, Whisper, TTS |
